...
name_zh: 孟菲斯
slug: g-memphis
description: "Playful geometry, dots, squiggles, pastel brights, and modular 1980s optimism."
...
A modular, playful system built from coral, teal, lavender, yellow, dots, waves, and simple geometry. Decorations stay in negative space while content remains structured and scannable.

## Identity Test

A deck belongs to this style only when all of the following are visible:
- coral, teal, lavender, and yellow with a three-accent cap per slide
- dots, squiggles, semicircles, and stepped shapes
- rounded geometric display type
- modular cards with varied silhouette but consistent alignment
...
- Display: **Fredoka / Noto Sans SC**
- Body: **DM Sans + Noto Sans SC**
- Metadata: **IBM Plex Mono**
- Google Fonts query: `https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,600&family=Fredoka:wght@400;500;600;700&family=IBM+Plex+Mono:wght@400;500&family=Noto+Sans+SC:wght@300;400;500;600;700;900&display=swap`

Rounded sans at 96–148px, weight 600–700. Chinese titles stay compact and may use one colored word.
...
Use an 8-column modular grid with 32px gutters. Shapes live in empty modules and do not sit behind text.
...
Recommended families: **G01, G02, G05, G06, G07, G08, G09, G12**.
...
Lifestyle, food, products, people in motion, workshops, and friendly spaces. Use bright crops and simple backgrounds.
...
Four-part features, steps, category comparisons, and simple scorecards. Avoid dense financial tables.

Use direct labels whenever possible. One slide answers one chart question. Keep units, sources, and time periods visible.

## Motion

Low-frequency spring movement, 360–560ms. One decorative object may bob subtly, with reduced-motion disabled.
...
- decorations covering body copy
- every card using a different color
- too many tiny icons
- serious risk or compliance content
- large empty areas filled with meaningless confetti
