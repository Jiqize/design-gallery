...
name_zh: 波普艺术
slug: g-pop-art
description: "Halftone dots, advertising color, black outlines, and punchy consumer-scale statements."
...
A commercial poster system with saturated primary colors, halftone screens, black outlines, offset shadows, cropped product or portrait imagery, and oversized value propositions.

## Identity Test

A deck belongs to this style only when all of the following are visible:
- halftone field in one controlled area
- thick black outline and offset print shadow
- one red or blue hero block on yellow or cream
- short ad-like headline and oversized number
...
- Display: **Anton / Noto Sans SC**
- Body: **DM Sans + Noto Sans SC**
- Metadata: **IBM Plex Mono**
- Google Fonts query: `https://fonts.googleapis.com/css2?family=Anton&family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,600&family=IBM+Plex+Mono:wght@400;500;600&family=Noto+Sans+SC:wght@400;500;700;900&display=swap`

Condensed or ultra-bold sans at 112–180px. Short Chinese titles may use 900 weight. Keep within two lines.
...
Use a 6×4 poster grid with thick 6–10px borders. Allow controlled collisions between title, image, and price or KPI burst.
...
Recommended families: **G01, G03, G05, G06, G08, G09, G12**.
...
Products, portraits, consumer artifacts, packaging, food, and entertainment. Increase contrast and simplify backgrounds.
...
Discounts, growth, reach, unit sales, ratings, and side-by-side product facts work well as bold numbers.

Use direct labels whenever possible. One slide answers one chart question. Keep units, sources, and time periods visible.

## Motion

Quick scale-in, hard cuts, and offset-shadow settle over 220–360ms. Avoid constant bounce.
...
- using comic bursts around every small fact
