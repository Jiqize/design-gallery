...
name_zh: 装饰艺术
slug: g-art-deco
description: "Black, ivory, old gold, symmetry, stepped geometry, and cinematic ceremony."
...
A symmetrical, ceremonial system with black or deep charcoal fields, ivory type, old-gold linework, stepped frames, sunburst geometry, and centered architectural composition.

## Identity Test

A deck belongs to this style only when all of the following are visible:
- central axis and mirrored spacing
- old-gold hairline frames and stepped corners
- high-contrast serif display with wide tracking
- fan, sunburst, or tower geometry used sparingly
...
- Display: **Cinzel / Noto Serif SC**
- Body: **Montserrat + Noto Sans SC**
- Metadata: **IBM Plex Mono**
- Google Fonts query: `https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600;700;800&family=IBM+Plex+Mono:wght@400;500&family=Montserrat:wght@300;400;500;600&family=Noto+Sans+SC:wght@300;400;500&family=Noto+Serif+SC:wght@400;500;600;700&display=swap`

Serif display at 88–142px, weight 500–600, often centered. English uppercase may use 0.12em tracking. Chinese tracking stays 0.04em or less.
...
Centered 10-column field with mirrored margins. Use a 2-column central spine for titles and 4+4 side content.
...
Recommended families: **G01, G02, G03, G05, G06, G09, G12**.
...
Night architecture, jewelry, metallic surfaces, film stills, symmetry, and centered portraiture. Keep lighting controlled.
...
Use a small number of figures as plaques, seals, or balanced columns. Avoid dense multi-series charts.

Use direct labels whenever possible. One slide answers one chart question. Keep units, sources, and time periods visible.

## Motion

Lines draw from center outward over 700–1000ms. Titles fade vertically. No abrupt bounce or glitch.
...
- casual asymmetry
- cartoon icons
- rough photocopy textures
- large technical tables with no ceremonial hierarchy
