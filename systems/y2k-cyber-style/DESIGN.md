---
version: 1.0.0
name: Y2K Digital Futurism
name_zh: Y2K 数字未来主义
slug: g-y2k
description: "Chrome, translucent interfaces, orbit lines, cyan-pink light, and millennial digital optimism."
...
# Y2K Digital Futurism · Y2K 数字未来主义
...
A digital-futurist system with deep navy, chrome-white, cyan and pink light, transparent panels, orbit lines, terminal microcopy, liquid-metal highlights, and optimistic interface modularity.

## Identity Test

A deck belongs to this style only when all of the following are visible:
- chrome or spectral headline treatment used on one phrase
- translucent interface panel with visible edge light
- orbit lines, coordinate grid, or radial target
- cyan and pink used as controlled light sources
...
- Display: **Orbitron / Noto Sans SC**
- Body: **Rajdhani + Noto Sans SC**
- Metadata: **IBM Plex Mono**
- Google Fonts query: `https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600&family=Noto+Sans+SC:wght@300;400;500;600;700&family=Orbitron:wght@400;500;600;700;800&family=Rajdhani:wght@300;400;500;600;700&display=swap`

Geometric display at 92–146px, weight 500–700, tight tracking. Chinese titles use Noto Sans SC and may receive a subtle chrome gradient.
...
12-column interface grid with 24px gutters. Use central focal areas and edge-aligned telemetry panels.
...
Recommended families: **G01, G02, G04, G05, G06, G08, G09, G11, G12**.
...
AI, games, 3D objects, digital products, hardware, avatars, and futuristic interfaces. Keep subjects centered in clean safe areas.
...
Product metrics, capability matrices, systems, specs, radar-like diagrams, and feature comparisons. Keep chart labels bright and direct.

Use direct labels whenever possible. One slide answers one chart question. Keep units, sources, and time periods visible.

## Motion

Glow ramps, panel drift, orbit line reveal, and 500–900ms parallax. Avoid strobing or high-frequency glitch.
...
- warm paper texture
- handmade photocopy noise
- ornate flowers
- excessive glass layers that reduce contrast
- using cyan, magenta, lime, and orange at equal intensity
